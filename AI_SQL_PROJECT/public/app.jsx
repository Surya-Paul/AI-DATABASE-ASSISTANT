...
// - On Vercel: API is on the same origin (empty string)
// - Local dev with separate frontend server on port 5173: point to backend on 8000
// - Local dev served from FastAPI on 8000: same origin (empty string)
    ...
    <div className="app-container">
      ...
      <div className="glass-panel input-area">
        ...
        <button 
          ...
          disabled={loading || uploading || confirmModal !== null}
...
function AssistantMessage({ msg, onCorrect }) {
  ...
  return (
    <div>
      ...
      {msg.result && msg.result.success && msg.result.rows && msg.result.rows.length === 0 && !msg.result.message && (
        <div className="info-text">Query executed successfully, but 0 rows were found.</div>
      )}
